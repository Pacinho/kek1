...
void FSecondTickFunction::ExecuteTick(
	float DeltaTime,
	ELevelTick TickType,
...
FString FSecondTickFunction::DiagnosticMessage()
{
	...
	: Super(ObjectInitializer)
{
	...
	OnCalculateCustomPhysics.BindUObject(this, &UPrimitiveComponent::SubstepTick);
}
